...
const textStyle1 = TextStyle(
    color: Color(0xFFFFFFFF), fontSize: 20.0); // Style for normal text
const textStyle2 = TextStyle(
    color: Color(0xFFFFFFFF),
    fontSize: 60.0,
    fontWeight: FontWeight.w900); // Style for larger, bold text
const textStyle3 = TextStyle(
    color: Color(0xFFFFFFFF),
    fontSize: 30.0,
    fontWeight: FontWeight.w900); // Style for medium-sized bold text
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        // Display the icon with specified size and color
        const SizedBox(height: 15.0),
        // Add spacing between the icon and title
        Text(title, style: textStyle1),
        // Display the title text with the defined text style
      ],
    );
  }
}
